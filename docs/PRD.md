...
| 순수 변환 로직 모듈 | **진행 중** | `src/entity/unit_converter.py` (stub, shim: `src/unit_converter.py`) |
...
## 7. API 계약 (`src/entity/unit_converter.py`)
...
| `docs/ARCHITECTURE.md` | ECB 레이어·모듈 맵 |
| `report/02_workbook_scope_verification.md` | 범위·검증 SSOT, SC-1~3, Test Loop |
| `.cursor/rules/` · `.cursorrules` | AI·TDD·Phase 규칙, API 계약 |
| `AGENTS.md` | Sub-Agent 역할 (tdd-coach 등) |
